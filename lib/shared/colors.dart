...
const primaryColor = Color.fromRGBO(246, 136, 147, 1);
...
class Palette {
  static const MaterialColor kToDark = MaterialColor(
    0xfff68893, // 0% comes in here, this will be color picked if no shade is selected when defining a Color property which doesn’t require a swatch.
    <int, Color>{
