                        ...
                        child: Padding(
                          ...
                          child: ListView.separated(
                              ...
                              itemBuilder: (context, index) => buildTrainItem(
                                    ...
                                    trainings?[index].trainings?.image,
                                    false,
                                    false,
                                  ),
                    ...
                    if ((packages?.length ?? 0) > 0)
                      ListView.separated(
                          ...
                          itemBuilder: (context, index) => buildTrainItem(
                                ...
                                packages?[index].package?.name,
                                packages?[index].package?.image,
                                false,
                                false,
                              ),
                    ...
                    if ((trainingPlan?.length ?? 0) > 0)
                      ListView.separated(
                          ...
                          itemBuilder: (context, index) => buildTrainItem(
                                ...
                                trainingPlan?[index].plane?.name,
                                trainingPlan?[index].plane?.img,
                                false,
                                false,
                              ),
                          separatorBuilder: (context, index) => const SizedBox(
                    ...
                    if ((foodPlan?.length ?? 0) > 0)
                      ListView.separated(
                          ...
                          itemBuilder: (context, index) => buildTrainItem(
                                ...
                                foodPlan?[index].plane?.name,
                                foodPlan?[index].plane?.img,
                                false,
                                false,
                              ),
                          separatorBuilder: (context, index) => const SizedBox(
